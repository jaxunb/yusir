...
local window = library:new("佳轩脚本2.586.0")
...
tool:Button("防掉线 防踢(必须)",function()
		   vu:Button2Down(Vector2.new(0,0),workspace.CurrentCamera.CFrame)
		   wait(1)
		   vu:Button2Up(Vector2.new(0,0),workspace.CurrentCamera.CFrame)
		end)
    
    tool:Button("佳轩工具箱",function()
    loadstring(game:HttpGet("http://jiami.guimei.work/a/1692039668.txt"))()
    end)
    
tool:Button("通用夜视",function(Value)
        if Value then
	...
	tool:Button("飞车",function()
        loadstring(game:HttpGet("http://jiami.guimei.work/a/1692161191.txt"))()
end)
...
tool:Button("枪械无后座",function()
loadstring(game:GetObjects("rbxassetid://10040701935")[1].Source)()
end)

local credits = creds:section("人物区",true)

credits:Button("人物透视",function()
        loadstring(game:GetObjects("rbxassetid://10092697033")[1].Source)()
end)

credits:Button("人物踏空",function()
     loadstring(game:HttpGet('https://raw.githubusercontent.com/GhostPlayer352/Test4/main/Float'))()
end)

credits:Button("人物爬墙",function()
loadstring(game:HttpGet("https://pastebin.com/raw/zXk4Rq2r"))()
end)

credits:Button("传送工具",function()
mouse = game.Players.LocalPlayer:GetMouse() tool = Instance.new("Tool") tool.RequiresHandle = false tool.Name = "[FE] TELEPORT TOOL" tool.Activated:connect(function() local pos = mouse.Hit+Vector3.new(0,2.5,0) pos = CFrame.new(pos.X,pos.Y,pos.Z) game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = pos end) tool.Parent = game.Players.LocalPlayer.Backpack
end)

credits:Button("人物范围",function()
loadstring(game:HttpGet('http://jiami.guimei.work/a/1692114606.txt'))()
end)

local creds = window:Tab("凹凸世界",'6035145364')

local tool = creds:section("自动获取裁判球",true)

tool:Button("自动获取裁判球",function()
...
local tool = creds:section("佳轩专区",true)

tool:Button("佳轩自制DOORS脚本『最强脚本』",function()
loadstring(game:HttpGet("http://jiami.guimei.work/a/1692177328.txt"))()
end)

local credits = creds:section("功能区",true)

credits:Button("lj穿墙",function()
...
credits:Button("神圣炸弹",function()
        loadstring(game:HttpGet("https://raw.githubusercontent.com/MrNeRD0/Doors-Hack/main/HolyGrenadeByNerd.lua"))()
end)

credits:Button("十字架封印一切按q使用",function()
        _G.Uses = 10000
_G.Range = 999
_G.OnAnything = true
_G.Fail = false
...
credits:Button("吸铁石",function()
        loadstring(game:HttpGet("https://raw.githubusercontent.com/MrNeRD0/Doors-Hack/main/MagnetByNerd.lua"))()
end)

credits:Button("紫色手电筒买东西时使用",function()
       loadstring(game:HttpGet("https://raw.githubusercontent.com/K0t1n/Public/main/Purple%20Flashlight"))()
end)

local creds = window:Tab("神仙功能",'6035145364')

local tool = creds:section("功能",true)

tool:Button("boss",function()
loadstring(game:HttpGet('http://jiami.guimei.work/a/1692026695.txt'))()
end)

tool:Button("变身史蒂夫",function()
loadstring(game:HttpGet('http://jiami.guimei.work/a/1691968002.txt'))()
end)
